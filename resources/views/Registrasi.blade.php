        ...
        <div class="p-4 m-auto flex items-center flex-col sm:w-[450px] w-full">
            ...
            <form action="" class="w-full">
                <div class="flex flex-col gap-1">
                    ...
                    <input type="text" class="px-2 py-3 rounded-md border border-gray-300 bg-gray-200" placeholder="Enter your name" id="name">
                </div>
                <div class="flex flex-col gap-1">
                    <label for="username" class="text-lg font-semibold">Username</label>
                    <input type="text" class="px-2 py-3 rounded-md border border-gray-300 bg-gray-200" placeholder="Enter your username" id="username">
                </div>
                <div class="flex flex-col gap-1">
                    <label for="email" class="text-lg font-semibold">Email address</label>
                    <input type="email" class="px-2 py-3 rounded-md border border-gray-300 bg-gray-200" placeholder="Enter your email" id="email" aria-describedby="emailHelp">
                </div>
                <div class="flex flex-col gap-1">
                    <label for="password" class="text-lg font-semibold">Password</label>
                    <input type="password" class="px-2 py-3 rounded-md border border-gray-300 bg-gray-200" placeholder="Enter your password" id="password">
                </div>
                <div class="mt-5">
